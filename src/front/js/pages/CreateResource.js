    ...
    <div className="row center mx-auto col-6 text-secondary mb-3">
      <div className="m-4">
        ...
        <div className="my-2">
          ...
          <form>
            <label htmlFor="appt">Monday from </label>
            <input
              type="time"
              id="appt"
              name="appt"
          ...
          <form>
            <label htmlFor="appt">Tuesday from </label>
            <input
              type="time"
              id="appt"
              name="appt"
          ...
          <form>
            <label htmlFor="appt">Wednesday from</label>
            <input
              type="time"
              id="appt"
              name="appt"
          ...
          <form>
            <label htmlFor="appt">Thursday from</label>
            <input
              type="time"
              id="appt"
              name="appt"
          ...
          <form>
            <label htmlFor="appt">Friday from</label>
            <input
              type="time"
              id="appt"
              name="appt"
          ...
          <form>
            <label htmlFor="appt">Saturday</label>
            <input
              type="time"
              id="appt"
              name="appt"
          ...
          <form>
            <label htmlFor="appt">Sunday</label>
            <input
              type="time"
              id="appt"
              name="appt"
